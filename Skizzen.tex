...
\newcommand\DisplayWidth{19.4} %Displaybreite (brutto)
\newcommand\DisplayHeight{11} %DisplayHöhe
\newcommand\DisplayBorder{1} %(Holz-)Rand um das Displayplexi frontplare Thickness
\newcommand\Depth{5} %Tiefe hinter dem Display bzw unter dem Display
\newcommand\Height{5} %Höhe unter dem Display bzw unter dem Display
\newcommand\Boxboxdepth{3} % Tiefe der Gelbdbox
\newcommand\Boxboxheight{6} % Höhe der inneren Box
...
%    \tikzexternaldisable
    \begin{tikzpicture}
      ...
      \draw[main] (\wood,-\wood) -- ++ ({((\Depth-\wood-\wood/sin(60))/4},0) -- ++ (0,\wood)
          -- ++ ({(\Depth-\wood-\wood/sin(60))/4},0) -- ++ (0,-\wood) -- ++ ({(\Depth-\wood-\wood/sin(60))/4},0)
    ...
    -- ++(270:2) -- ++(0:\wood) -- ++(90:2) -- ++(180:\wood);
      \node[anchor = south,align=center] at ( $(BottomRight) !.5! (Bottom Left) $) {\Large IceBoxWoodBox\\\vspace{2\baselineskip}};
  ...
  \begin{center}
    ...
    \begin{tikzpicture}[rotate=90]
      ...
      \draw[main] (0,-\wood)
        ...
        \draw[main]
        % slot
        ({(\DisplayWidth+2*\DisplayBorder)/2-\slotWidth/2},{-\Boxboxdepth/2+\slotHeight/2})
        rectangle
        ({(\DisplayWidth+2*\DisplayBorder)/2+\slotWidth/2},{-\Boxboxdepth/2-\slotHeight/2});
        \draw[main]
      ...
      \ifshowDetails
        ...
        \node[xshift=.5\baselineskip,rotate=90] (B) at ({(\DisplayWidth+2*\DisplayBorder)/2},-\Depth) {Front};
      \fi
    \end{tikzpicture}
    \\
  ...
  \begin{center}  
    ...
    \begin{tikzpicture}[rotate=90]
      ...
      \ifshowDetails
        ...
        \node[xshift=.5\baselineskip,rotate=90] (B) at ({(\DisplayWidth+2*\DisplayBorder)/2},{-\sideHeight-\Depth}) {bottom};
  ...
  \begin{center}
    ...
    \begin{tikzpicture}[rotate=90]
      ...
      \ifshowDetails
        \node[xshift=-.5\baselineskip,rotate=90] (A) at ({(\DisplayWidth+2*\DisplayBorder)/2},0) {top};
        \node[xshift=.5\baselineskip,rotate=90] (B) at ({(\DisplayWidth+2*\DisplayBorder)/2},{-\Height}) {bottom};
      \fi
    \end{tikzpicture}
    \\
    5 – Frontblende unten
  ...
  \begin{center}
    \tikzexternaldisable
      ...
      \ifshowDetails
        \node[xshift=-.5\baselineskip,rotate=90] (A) at ({(\DisplayWidth+2*\DisplayBorder)/2},0) {top};
        \node[xshift=.5\baselineskip,rotate=90] (B) at ({(\DisplayWidth+2*\DisplayBorder)/2},{-\DisplayHeight-2*\DisplayBorder}) {front};
      \fi
    \end{tikzpicture}
    \\
    6 – Displayplatte
  ...
  \begin{center}  
    ...
    \begin{tikzpicture}[rotate=90]
      \ifshowDetails
      \draw[base] (0,0) rectangle ({\DisplayWidth+2*\DisplayBorder-2*\wood},{-\wood-\wood/2-\Boxboxheight});
      \fi
      \draw[main] (0,-\wood)%
